function [new_buffer, new_packet_loss, new_uplink_state, new_MS_collision, remaining_data,new_currentMS] = busy(currentMS, buffer, capacity, AP_SINR, sinr_thres, MS_IN, Ith, MS_collision, payload_size, uplink_state, remaining_data, remaining_time)
