function [new_buffer, new_packet_loss, new_downlink_collision, new_remaining_data, MS_lost] = downlink_busy(buffer, capacity, downlink_SINR, sinr_thres, downlink_collision, payload_size, remaining_data)
